...
public class AuctionControllerTests : IAsyncLifetime
{
    ...
    public async Task GetAuctionById_WithValidId_ShouldReturnAuction()
    {
        ...
        //act
        var response = await _httpClient
            .GetFromJsonAsync<AuctionDto>($"api/auctions/{FORDGT_ID}");
    ...
    public async Task UpdateAuction_WithValidUpdateDtoAndUser_ShouldReturn200()
    {
        ...
        // act
        var response = await _httpClient
            .PutAsJsonAsync($"/api/auctions/{FORDGT_ID}", updateAuctionDto);
        // assert
    ...
    {
        var updateAuctionDto = new UpdateAuctionDto { Make = "Toyota" };
        _httpClient.SetFakeJwtBearerToken(AuthHelper.GetBearerForUser("chok"));
        // act
        var response = await _httpClient
            .PutAsJsonAsync($"/api/auctions/{FORDGT_ID}", updateAuctionDto);
        // assert
