...
public class AuctionControllerTests
{
    ...
    public AuctionControllerTests()
    {
        ...
        _controller = new AuctionsController(
            _auctionRepo.Object, _mapper, _publishEndPoint.Object)
        {
    ...
    {
        //arrange
        //_fixture will create 10 AuctionDto and store them in auctions variable
    ...
    public async Task UpdateAuction_WithUpdateAuctionDto_ReturnsOkResponse()
    {
        ...
        //create auction object like this to prevent circular recursion behavior
